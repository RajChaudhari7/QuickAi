          ...
          <div key={index} className='relative group inline-block pl-3 pt-3 w-full sm:max-1/2 lg:max-w-1/3'>
            ...
            group-hover:bg-gradient-to-b from-transparent to-black/80 text-white rounded-lg'>
              ...
              <div className='flex gap-1 items-center'>
                ...
                <Heart onClick={() => imageLikeToggle(creation.id)} className={`min-w-5 h-5 hover:scale-110 cursor-pointer ${creation.likes.includes(user.id) ? 'fill-red-500 text-red' : 'text-white'}`} />
              </div>
            </div>

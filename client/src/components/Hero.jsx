...
const Hero = () => {
    ...
    return (
        <div className=" px-4 sm:px-20 xl:px-32 inline-flex flex-col w-full  justify-center bg-[url('/src/assets/gradientBackground.png')] bg-cover bg-no-repeat min-h-screen">
            ...
            <div className='flex flex-wrap justify-center gap-4 text-sm max-sm:text-xs'>
                <button
                    onClick={() => { navigate('/ai'); scrollTo(0, 0); }}

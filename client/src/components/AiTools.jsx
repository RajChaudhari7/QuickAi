    ...
    return (
        <div className='px-4 sm:px-20 xl:px-32 my-24'>
            <div className='text-center'>
                ...
                <p className='text-gray-500 max-w-lg mx-auto'>Everything you need to create, enhance, and optimize your contact with cutting-edge AI technology.</p>
            </div>
            ...
            <div className='flex flex-wrap mt-10 justify-center '>
                {AiToolsData.map((tool, index) => (
                    ...
                    key={index} onClick={() =>user && navigate(tool.path)}>
